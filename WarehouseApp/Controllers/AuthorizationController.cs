...
namespace WarehouseApp.Controllers
{
    ...
    public class AuthorizationController : ControllerBase
    {
        ...
        public AuthorizationController(IOptions<AuthOptions> authOptions, WarehouseDbContext context)
        {
        ...
        {
            return warehouseDbContext.Accounts.SingleOrDefault(u => u.Login == login && u.Password == passord);
        }
